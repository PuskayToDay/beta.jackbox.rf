        ...
        52650: (t, e, i) => {
            ...
            const w = d.S.extend({
                    defaults: {
                        ...
                        isLocal: !1,
                        strings: {
                            wait: "Присядь и раслабся!",
                            vip_waiting: "Ожидаем пока все игроки зайдут в комнату",
                            vip_canStart: "PНажми эту кнопку когда все зайдут",
                            vip_cancel: "Нажми эту кнопку чтопы отменить запуск",
                            vip_postgame: "Что будем делать?",
