            ...
            const o = {
                en: {
                    ...
                    ENTRY: {
                        ...
                        ROOM_CODE_PLACEHOLDER: "4-ЁХ ЗНАЧНЫЙ КОД"
                    },
                    ERROR: {
                        DISCONNECTED: "Тебя выкинуло из комнаты.",
                        DRAWING_NOTHING: "You have to draw something!",
                        PLAYER_KICKED: "Тебя выгнали...",
                        ROOM_DESTROYED: "Спасибо за игру!",
                        ROOM_DISCONNECTED: "Соединение оборванно",
                        ROOM_NOT_FOUND: "Такой комнаты несуществует",
