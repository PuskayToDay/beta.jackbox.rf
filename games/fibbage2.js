    ...
    ["games/fibbage2"], {
        ...
        91791: (e, t, o) => {
            ...
            var i = o(19755),
                ...
                g = h()(d);
            const p = '<div id="page-fibbage" class="page green"> <link href="https://fonts.googleapis.com/css?family=Raleway:800" rel="stylesheet"> <div id="player"> <h1><%=username%></h1> </div> <div id="fibbage-preload" class="fibbage-preload"></div> <div id="game" class="game pt-pageholder"> <div class="pt-page-off state-lobby fibbage-page"> <div class="container"> <br/><span id="fibbage-lobby-text"></span><br/> <form class="pure-form"> <button type="button" id="fibbage-startgame" class="button-fibbage button-xlarge pure-button pure-input-1">ВСЕ ЗДЕСЬ</button> <button type="button" id="fibbage-stopcountdown" class="button-fibbage button-xlarge pure-button pure-input-1">ОТМЕНА</button> <button type="button" id="fibbage-sameplayers" class="button-fibbage button-xlarge pure-button pure-input-1 fibbage-endbuttons">Новая игра с теми же игроками</button> <button type="button" id="fibbage-newplayers" class="button-fibbage button-xlarge pure-button pure-input-1 fibbage-endbuttons">Новая игра с новыми игроками</button> </form> </div> </div> <div class="pt-page-off state-nothing fibbage-page"> <div class="logo-image" style="width:100%"> <img class="pure-img" style="margin-left:auto;margin-right:auto" src="' + g + '"> </div> </div> <div class="pt-page-off state-round fibbage-page"> <div class="round-main"><p class="round-text"></p></div> </div> <div class="pt-page-off state-pickbloop fibbage-page"> <div class="container"> <br/><span>ВЫБЕРИ СВОЙ ЗВУК ДЛЯ ИГРЫ!</span><br/> <div class="button-container"> <form class="pure-form"> <fieldset class="bloop-fieldset"> </fieldset> </form> </div> </div> </div> <div class="pt-page-off state-choosing fibbage-page"> <div class="container"> <br/><span>ВЫБЕРИ КАТЕГОРИЮ</span><br/> <div class="button-container"> <form class="pure-form"> <fieldset class="button-fieldset"> </fieldset> </form> </div> </div> </div> <div class="pt-page-off state-enterlie fibbage-page"> <div class="container"> <br/><span id="question-text"></span><br/><br/> <div id="fibbage-submit-alert" class="alert alert-info">Тревожное сообщение будет здесь</div> <form class="pure-form" id="fibbage-enterlie-field"> <div class="pure-u-1"> <input id="fibbage-lie-input" name="fibbage-lie" class="pure-input-1 capitalize jbg-input fibbage-lie-input" type="text" maxlength="45" placeholder="ВВЕДИТЕ ЛОЖЬ" autocapitalize="off" autocorrect="off" autocomplete="off"> </div> <button type="button" id="fibbage-lieforme" class="button-fibbage button-large pure-button capitalize left">Солги для меня<br/>(Половина очков)</button> <button type="submit" id="fibbage-submitlie" class="button-fibbage button-large pure-button capitalize right"><i class="fas fa-paper-plane"></i>ОТПРАВИТЬ</button> <div id="fibbage-submitlie-loading" style="display:none" class="button-fibbage-loading"></div> </form> <div id="fibbage-suggestions" class="pure-g"></div> </div> </div> <div class="pt-page-off state-chooselie fibbage-page"> <div class="container"> <br/><span id="chooselie-text"></span><br/> <form id="fibbage-chooselie" class="pure-form"></form> <br/> <form id="fibbage-defib" class="pure-form"> <button type="button" data-param="defib" class="pure-input-1 fibbage-defib-button button-large pure-button button-fibbage button-fibbage-defib"><img class="defib-icon" src="' + h()(b) + '"/>&nbsp;&nbsp;&nbsp;&nbsp;ВИТАМИН<font color="red">Б</font></button> <br/><span>СОКРАТИТЕ ЧИСЛО ВАРИАНТОВ ДО ДВУХ!</span> </form> </div> </div> <div class="pt-page-off state-chooselikes fibbage-page"> <div class="container"> <br/><span id="chooselikes-choice"></span><br/> <span id="chooselikes-text"></span><br/> <form id="fibbage-chooselikes" class="pure-form"></form> </div> </div> <div class="pt-page-off state-liereceived fibbage-page"> <br/><span>ЛОЖЬ ВВЕДЕНА!<br/>ОЖИДАЕМ ДРУГИХ ИГРОКОВ.</span><br/> </div> <div class="pt-page-off state-lyingdone fibbage-page"> <br/><span>ГОТОВО</span><br/> </div> <div class="pt-page-off state-notchoosing fibbage-page"> <br/><span id="notchoosing"></span><br/> </div> <div class="pt-page-off state-audience-join fibbage-page"> <br/> <img style="margin-left:auto;margin-right:auto;max-width:75%;max-height:75%" src="' + g + '"> <span> <br/><br/> You can “Like” your favorite lies (one Like per question). <br/><br/> - И - <br/><br/> Вы можете играть, угадывая истину в каждом вопросе! Наберите идеальное количество очков (7/7) и получите бесплатный странный бонусный факт - отличный вариант для вечеринок! </span> <br/> </div> <div class="pt-page-off state-audience-postgame fibbage-page"> <div class="container"> <br/><img style="margin-left:auto;margin-right:auto;max-width:75%;max-height:75%" src="' + g + '"> <br/><br/><span>ФИНАЛЬНЫЙ СЧЁТ</span><br/><br/> <span id="audience-postgame-score" class="audience-score"></span><br/><br/> <span id="audience-postgame-score-quip"></span><br/><br/> <div class="audience-bonus-fact"><span id="audience-bonus-fact" class="audience-bonus-fact"></span></div><br/> <span id="audience-bonus-quip"></span><br/><br/> </div> </div> <div class="pt-page-off state-audience-score fibbage-page"> <div class="container"> <br/><img style="margin-left:auto;margin-right:auto;max-width:75%;max-height:75%" src="' + g + '"> <br/><br/><span>ВАШ РЕЗУЛЬТАТ НА ДАННЫЙ МОМЕНТ</span><br/><br/> <span id="audience-score" class="audience-score"></span><br/><br/> <span id="audience-score-quip"></span> </div> </div> <div class="pt-page-off state-audience-chooselie fibbage-page"> <div class="container"> <br/><span id="audience-chooselie-text"></span><br/> <form id="fibbage-audience-chooselie" class="pure-form"></form> </div> </div> <div class="pt-page-off state-audience-chooselikes fibbage-page"> <div class="container"> <br/><span id="audience-chooselikes-choice"></span><br/> <span id="audience-chooselikes-text"></span><br/> <form id="fibbage-audience-chooselikes" class="pure-form"></form> </div> </div> </div> </div> ';
            ...
            const m = r.I.extend({
                ...
                updatePlayer() {
                    ...
                    if ("Lobby_PickBloop" === o) {
                        ...
                        if (o && "Lobby" === o.split("_")[0]) {
                            ...
                            const t = o.split("_")[1];
                            "WaitingForMore" === t ? a()("#fibbage-lobby-text").html("Ждём пока все зайдут") : "CanStart" === t ? (a()("#fibbage-lobby-text").html("Нажми на эту кнопку когда все зайдут"), a()("#fibbage-startgame").show()) : "Countdown" === t ? (a()("#fibbage-lobby-text").html("Нажми эту кнопку чтобы отменить запуск игры"), a()("#fibbage-stopcountdown").show()) : "PostGameHost" === t ? (a()("#fibbage-lobby-text").html("Что сейчас?"), a()(".fibbage-endbuttons").show()) : "PostGame" === t && a()("#fibbage-lobby-text").html("Waiting for host decision"), this.showScreen(".state-lobby")
                        }
                    ...
                    else if ("Gameplay_Round" === i) a()(".round-text").html(`РАУНД ${t.round}`), this.showScreen(".state-round");
                        ...
                        } else a()("#notchoosing").html(`${c.c.safeText(t.choosingPlayerName)} выберает категорию`), this.showScreen(".state-notchoosing");
                        ...
                        if (e.choosingDone || void 0 !== e.chosen) {
                            a()("#chooselikes-choice").html(e.chosen ? `Ты выбрал: ${e.chosen}` : "You didn't make a choice"), a()("#chooselikes-text").html("Поставь бонусные лайки");
                            let t = "";
                            ...
                            a()("#chooselie-text").html("НАЙДИ ПРАВДУ!");
                            let t = "";
                ...
                updateAudienceLikes() {
                    const e = this.model.get("room");
                    a()("#audience-chooselikes-choice").html(`Ты выбрал: ${""===this.currentChoice?"NO ANSWER!":this.currentChoice}`), a()("#audience-chooselikes-text").html("Award a like");
                ...
                updateAudience() {
                    ...
                    else if ("Gameplay_Round" === t) a()(".round-text").html(`РАУНД ${e.round}`), this.showScreen(".state-round");
                ...
                sanitize: e => e ? e.replace(/[^A-Z0-9\u00A1\u0020-\u002F\u00BF-\йцукенгшщзхъфывапролджэёячсмитьбюЙЦУКЕНГШЩЗХЪФЫВАПРОЛДЖЭЁЯЧСМИТЬБЮ\u00FF!?*$+\-’'_ .,]/gi, "").replace(/'/g, "’").trim() : e,
                onResize() {
