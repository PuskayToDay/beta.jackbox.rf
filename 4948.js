(self.webpackChunkjackbox_tv = self.webpackChunkjackbox_tv || []).push([
    [4948], {
        14948: (e, t, s) => {
            ...
            const U = {
                en: {
                    STATUS_GAME_FULL: "Игра заполнена",
                    STATUS_GAME_STARTED: "Игра уже началась",
                    STATUS_ROOM_NOT_FOUND: "Такой комнаты нет",
                    SUBMIT_GAME_FULL: "ИГРА ЗАПОЛНЕНА",
                    SUBMIT_GAME_STARTED: "ИГРА НАЧАЛАСЬ",
                    SUBMIT_JOIN_AUDIENCE: "ПРИСОЕДЕНИТЬСЯ К ПУБЛИКЕ",
                    SUBMIT_RECONNECT: "ПЕРЕЗАЙТИ",
                    SUBMIT_TWITCH_LOGIN: "ЗАЙТИ ЧЕРЕЗ TWITCH",
                    TOS_WARNING: "Нажимая {submit}, Вы соглашаетесь с [tos]Условиями пользования[/tos]",
                    ...
                    STRING_TEXT_SUBMIT_ALERT: "Ты не можешь ничего не ввести!",
                    STRING_ERROR_INVALID_ROOM_CODE: "Неправильный код комнаты",
                    ...
                    STRING_NAME: "ИМЯ",
                    STRING_NAME_PLACEHOLDER: "ВВЕДИ СВОЁ ИМЯ",
                    ...
                    STRING_MENU_MAILING_LIST: "MAILING ЛИСТ",
                    ...
                    ERROR_ROOM_FULL: "Игра заполнена",
                    ERROR_AUDIENCE_FULL: "Публика переполнена",
                    ...
                    AD_ON_SALE: "On Sale!",
                    STRING_PASSWORD_REQUIRED_TITLE: "Запрашивается пароль",
                    STRING_PASSWORD_REQUIRED_BODY: "Пожалйста введи пароль, или зайди к публике",
                    STRING_PASSWORD_JOIN_AS_PLAYER: "Зайти игроком",
                    STRING_PASSWORD_JOIN_AS_AUDIENCE: "Зайти в публику",
                    ...
                    STRING_ERROR_REQUIRES_TWITCH_LOGIN: "Игра запрашивает TWITCH чтобы играть.",
                    STRING_ERROR_ROOM_IS_LOCKED: "Игра закрыта",
                    STRING_ERROR_INCORRECT_PASSWORD: "Неправильный пароль",
